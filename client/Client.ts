...
/**
 * launches the game in the client and creates a new player
 * based on the passed in inputs
 * 
 * @param name player name
 * @param hue player color tint (hue shift from red, between 0 and 360 deg)
 * @param brightness player color brighness (>= 1)
 */
export const launchClient = (name: string, hue: number, brightness: number) => {
    ...
    class Amogus extends Game {
        public start() {
            ...
            SocketManager.instance.init(name, hue, brightness)
